		...
		<table style="border:none;">
		    <tbody>                        
		        <tr class="prop">
		            ...
		            <td><span class="help action" title="${message(code:'document.title.help',default:'Document name|Enter the name of the document here')}" href="" >&nbsp;</span></td>		                               
		        </tr>
		        <tr class="prop null">
		            ...
		            <td><span tabindex="9999" class="help action" title="${message(code:'document.summary.help',default:'Summary|Enter a document summary here')}" href="" >&nbsp;</span></td></tr>                                                   
		    </tbody>
		</table>
	</g:form>     
</div> 
