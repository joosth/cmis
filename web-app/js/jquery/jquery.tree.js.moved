	...
	$.tree = {
		...
		defaults	: {
			...
			callback	: {
				...
				beforemoveadvice	: function(NODE,REF_NODE,TYPE,TREE_OBJ,IS_COPY) { return "asis" },
	...
	function tree_component () {
		return {
			...
			moved : function (what, where, how, is_new, is_copy, rb) {
				...
				switch (this.callback("beforemoveadvice", [this.get_node(what).get(0), this.get_node(where).get(0),how,this,is_copy])) {
					case "asis":
						break;
					case "abort":
						return false;
